...
function ShipmentQuotePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (numberofRoomP <= 0) {
            toast.error(selectedLanguage === "EN" ?'Positive pickup number of rooms required' : `Un nombre positif de chambres pour le ramassage est requis.`, {
                position: 'top-right',
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        if (numberofRoomD <= 0) {
            toast.error(selectedLanguage === "EN" ?'Positive destination number of rooms required' : `Un nombre positif de chambres de la destination est requis`, {
                position: 'top-right',
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        let pickupLocation: string = pickUpAddress + ', ' + cityP + ', ' + countryP
        let destinationLocation: string = dropOffAddress + ', ' + cityD + ', ' + countryD
        if (pickupLocation === destinationLocation) {
            toast.error(selectedLanguage === "EN" ?`Error : Same pickup and destination address` : `Erreur : Adresse de ramassage et de destination identique`, {
                position: 'top-right',
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
        ...
        try {
            ...
            toast.success(selectedLanguage === "EN" ?'Request quote sent successfully !' : `Demande de devis envoyée avec succès !`, {
                position: 'top-right',
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
    ...
    const clearInputFields = () => {
        ...
        var userQuoteForm  = document.getElementById("userQuoteForm");
        // @ts-ignore
        userQuoteForm.reset()
    }
                        ...
                        <div className="flex flex-col gap-2 mb-10">
                            ...
                            <div className="bg-white shadow-lg border rounded-md flex flex-col gap-5 px-10 py-10">
                                ...
                                <div className="flex gap-5 flex-wrap">
                                    ...
                                    <div className="text-[#696969] text-sm">
                                        <div>
                                            {selectedLanguage === "EN" ? "Is there an elevator ?" : "Y a-t-il un ascenseur ?"}
                                        </div>
